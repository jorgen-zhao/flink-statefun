...
public final class NatsIngressBuilderApiExtension {

    private NatsIngressBuilderApiExtension() {
    }

    public static <T> void withDeserializer(NatsIngressBuilder<T> natsIngressBuilder,
                                            NatsIngressDeserializer<T> deserializer) {
        natsIngressBuilder.withDeserializer(deserializer);
    }
}
